...
OUTPUT_DIR="$PROFILE_DIR/devops-admin/cron/output"
...
${content}"
    ...
    "$HERMES_BIN" -p marc-default chat -q "SILENT: Send message to Telegram chat ${TELEGRAM_CHAT_ID}: ${message}" > /dev/null 2>&1 || true
