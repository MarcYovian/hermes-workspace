...
| server-health | monitoring | Daily health check — uptime, CPU, RAM, disk, Docker, services, network, updates | skills/monitoring/server-health/SKILL.md |
| server-health-report | monitoring | Generate formatted server health report in Indonesian for Telegram delivery | skills/monitoring/server-health-report/SKILL.md |
| vps-sinyora-health | monitoring | VPS Sinyora specific health monitoring — services, resources, connectivity | skills/monitoring/vps-sinyora-health/SKILL.md |
| vps-sinyora-backup | monitoring | Automated database backup routine for VPS Sinyora | skills/monitoring/vps-sinyora-backup/SKILL.md |
| vps-sinyora-ssl-monitor | monitoring | SSL certificate expiry monitoring and renewal reminder for VPS Sinyora | skills/monitoring/vps-sinyora-ssl-monitor/SKILL.md |
