...
1. Delegate infra diagnosis → `devops-admin`
2. Delegate application diagnosis → `dev-coder`
...
## 5.1 Infrastructure & Security Routing → `devops-admin`
...
## 5.2 Application & Coding Routing → `dev-coder`
